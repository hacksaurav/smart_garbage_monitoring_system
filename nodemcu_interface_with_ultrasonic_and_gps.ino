...
SoftwareSerial ss(4, 5); // The serial connection to the GPS device   
                         //D1 where RX is connected
                         //D2 where TX is connected


char auth[] = "f2374e0e9f99435ea773cf8bb9942e38";
...
void loop(){
  ...
  if(  distance <15){
    red.on();
    Blynk.notify("Dustbin no x is more than 75% full");
    }
